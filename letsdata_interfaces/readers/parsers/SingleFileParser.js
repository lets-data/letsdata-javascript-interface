...
export class SingleFileParser {
     ...
     * @param byteArr - the byteArr that has the contents of the record - type is Uint8Array and is created by calling the TextEncoder.encode(strContents) method - https://developer.mozilla.org/en-US/docs/Web/API/TextEncoder
